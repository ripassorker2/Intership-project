   ...
   return (
      <div className="max-w-screen-xl mx-auto w-[90%] lg:my-28 my-14">
         ...
         <h2 className="text-center my-10 px-4">
            At our organisation we work on separate programmes like STEWACD, it
            is the acronym of Support Towards Empowerment of Women and Child
            Development. This initiative is mainly focussed on the UNSDG
            Goals-4,5 namely Quality Education and Gender Equality. We initiate
            these things in school children as they are prone to difference in
            households and schools for doing various works based on their
            gender. Under this flagship we conduct the following programmes.
         </h2>
         <div
            className=" lg:card-side bg-base-100 drop-shadow-xl 
         ...
         >
            ...
            <div className="px-2">
               ...
               <p className="flex leading-6 mt-2">
                  ...
                  Sessions on LSRW (Listening, Speaking, Reading and Writing)
                  Skills at Schools
               </p>
               ...
               <p className="flex leading-6">
                  ...
                  Conducting Essay Writing, Elocution, Debate, Quiz and Drawing
                  at Schools and colleges and awarding the winners for
                  encouragement.
               </p>
            </div>
         </div>
         ...
         >
            ...
            <div className="px-2">
               ...
               <p className="flex leading-6">
                  ...
                  Sessions on the Gender Identity and Sexual Orientation,
                  Awareness on LGBTQ.
               </p>
               <p className="flex leading-6">
                  <span className="text-[18px] mt-1 mr-2">
