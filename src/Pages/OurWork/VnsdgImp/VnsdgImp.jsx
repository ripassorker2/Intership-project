      ...
      <div className="max-w-screen-xl mx-auto w-[90%] lg:my-28 my-14">
         <div className="text-center">
            <h1 className="unsdgs-title inline-flex">
               UNSDGs{" "}
               <span className="md:inline-block hidden">IMPLEMENTATION</span>
            </h1>
         </div>
         <h2 className="text-center my-10 m-4">
            There are 17 United Nations Sustainable Development Goals listed by
            the United Nations to achieve it by the 2030 in order to make this
            continent Peaceful, Sustainable and Inclusive. Here, at The Change
         ...
         >
            ...
            <div className="px-2">
               ...
               <p className="flex">
                  ...
                  Anathasramam and provided food three times a day along with
                  Fruits and Milk.
               </p>
            </div>
         </div>
         ...
         >
            ...
            <div className="px-2">
               ...
               <p className="flex">
                  ...
                  Sessions and Panel discussions with farmers and
                  agriculturalists for better Planning and cropping patterns.
               </p>
            </div>
         </div>
      </div>
