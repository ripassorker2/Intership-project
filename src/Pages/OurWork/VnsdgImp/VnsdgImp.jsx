...
const VnsdgImp = () => {
   return (
     <div className="max-w-screen-xl mx-auto w-[90%] lg:my-16 md:my-10 my-5">
       ...
       <h2 className="lg:my-8 md:my-6 my-2 px-4">
         There are 17 United Nations Sustainable Development Goals listed by the
         United Nations to achieve it by the 2030 in order to make this
         continent Peaceful, Sustainable and Inclusive. Here, at The Change we
