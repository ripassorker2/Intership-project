     ...
     <div className="mx-7">
       ...
       >
         ...
         <div className="flex flex-col justify-center items-center pb-5 text-gray-200 md:text-lg  ">
           <div className="inline-block border p-8 xl:w-80 xl:h-80 md:w-52 md:h-52 w-48 h-48 bg-[#34910b] rounded-full max-w-[440px] text-center font-serif">
             <div className="w-full flex justify-center">
               <img className="w-20" src={logo} alt="" />
             </div>
             <p className="xl:text-4xl md:text-1xl text-xl font-bold xl:mt-6 md:mt-2">
