...
const InclusiveIcon = () => {
    return (
        ...
        <g id="Shopicon">
            <path d="M17,22c1.274,0,2.473-0.305,3.542-0.835c-2.66-2.167-4.361-5.466-4.361-9.165c0-2.176,0.598-4.208,1.624-5.959
                C17.541,6.014,17.272,6,17,6c-4.418,0-8,3.582-8,8S12.582,22,17,22z"/>
            <circle cx="28" cy="12" r="7.819"/>
